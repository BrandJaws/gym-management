                            ...
                            <div class="kt-portlet__body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="date" name="dateOfBirth" class="form-control" placeholder="Enter your code">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        ...
                                        <input type="date" name="joinDate" class="form-control" placeholder="Enter Your Specialization">
                                    </div>
                                    <div class="col-lg-6">
                                        <label>Address:</label>
