            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                        <form action="{{route('restaurant.subCategoryStore')}}" method="POST" enctype="multipart/form-data"
                              class="kt-form kt-form--label-right">
                            @csrf
                            <input type="hidden" class="form-control" name="gym_id" value="{{  Auth::guard('employee')->user()->gym->id }}"/>
                            <input type="hidden" class="form-control" name="restaurant_main_category_id" value="{{  $category->id }}"/>
