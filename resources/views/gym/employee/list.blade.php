                    ...
                    <div class="kt-portlet">
                        <div class="kt-portlet__head" style="align-items: center">
                            ...
                            <div class="dropdown dropdown-inline">
                                <a href="{{route('employee.create')}}" type="button" class="btn btn-brand btn-icon-sm">
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <div class="table-responsive">
                                                <table class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                    @include('gym.employee.pagination_data')
                                                    </tbody>
                                                </table>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "/gym/employee?page=" + page + "&sortby=" + sort_by + "&sorttype=" + sort_type + "&query=" + query,
