            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="kt-portlet">
                        ...
                        <!--begin::Form-->
                        <form action="{{route('shop.productStore')}}" method="POST" enctype="multipart/form-data"
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <select name="category_id" class="form-control">
                                                    @foreach($shopCategory as $row)
                                                        <option value="{{ $row->id}}" @if($selectCategory->id == $row->id) selected @endif>{{ $row->name}}</option>
                                                    @endforeach
                                                </select>
