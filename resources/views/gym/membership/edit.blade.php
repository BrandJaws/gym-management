                            ...
                            <div class="kt-portlet__body">
                                <div class="form-group row">
                                    <div class="col-lg-4 gymDropdown ">
                                        <label>Gym:</label>
                                        @if(count($gym) > 1)
                                            <select class="form-control kt-select2" id="kt_select2_3" name="gym_id[]" required value="{{$membership->gym_id}}"
                                                    multiple="multiple">
                                                @foreach ($gym as $gymList)
                                                    <option value="{{$gymList->id}}"  {{in_array("$gymList->id",$gymSelectedList)?"checked":""}}  >{{$gymList->name}}</option>
                                                @endforeach
                                            </select>
                                        @else
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" name="duration" class="form-control" required value="{{$membership->duration}}" />
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Amount:</label>
                                        <input type="text" name="amount" class="form-control" required value="{{$membership->amount}}">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <input type="text" name="monthlyFee" class="form-control" required value="{{$membership->monthlyFee}}" />
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-6">
                                        <label>Detail:</label>
                                        <input type="text" name="detail" class="form-control" required value="{{$membership->detail}}" />
