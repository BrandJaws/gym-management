                                ...
                                <div class="kt-section__content">
                                    ...
                                    <div class="      ">
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tr>
                                                ...
                                                <th class="sorting" data-sorting_type="asc"
                                                    data-column_name="name" style="cursor: pointer">Name <span
                                                        id="id_icon"></span></th>
                                                <th class="sorting" data-sorting_type="asc"
                                                    data-column_name="duration" style="cursor: pointer">Code
                                                    <span
                                                        id="post_title_icon"></span></th>
                                                <th class="sorting" data-sorting_type="asc"
                                                    data-column_name="amount" style="cursor: pointer">Fee <span
                                                        id="post_title_icon"></span></th>
                                                <th class="sorting" data-sorting_type="asc"
                                                    data-column_name="monthlyFee" style="cursor: pointer">Status
                                                    <span
                                                        id="post_title_icon"></span></th>
                                                <th class="sorting" data-sorting_type="asc"
                                            ...
                                            <tbody>
                                            @include('gym.service.pagination_data')
                                            </tbody>
                                        </table>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "/gym/service?page=" + page + "&sortby=" + sort_by + "&sorttype=" + sort_type + "&query=" + query,
