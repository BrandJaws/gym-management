                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <th class="sorting" data-sorting_type="asc"
                                                        data-column_name="dateOfBirth" style="cursor: pointer">Date of Birth <span
                                                            id="post_title_icon"></span></th>
                                                    <th class="sorting" data-sorting_type="asc"
                                                        data-column_name="gender" style="cursor: pointer">Gender <span
                                                            id="post_title_icon"></span></th>
                                                    <th class="sorting" data-sorting_type="asc"
                                                        data-column_name="meritalStatus" style="cursor: pointer">Merital Status <span
                                                            id="post_title_icon"></span></th>
                                                    <th class="sorting" data-sorting_type="asc"
                                                    ...
                                                    <th class="sorting" data-sorting_type="asc"
                                                        data-column_name="phone" style="cursor: pointer">Phone <span
                                                            id="post_title_icon"></span></th>
                                                    <th class="sorting" data-sorting_type="asc"
                                                        data-column_name="joinDate" style="cursor: pointer">Date of Joining <span
                                                            id="post_title_icon"></span></th>
                                                    <th class="sorting" data-sorting_type="asc"
                                                ...
                                                <tbody>
                                                @include('gym.member.pagination_data')
                                                </tbody>
                                            </table>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function fetch_data(page, sort_type, sort_by, query) {
                $.ajax({
                    url: "/gym/member?page=" + page + "&sortby=" + sort_by + "&sorttype=" + sort_type + "&query=" + query,
