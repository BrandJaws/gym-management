    ...
    <div class="kt-header-menu-wrapper" id="kt_header_menu_wrapper">
        <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile  kt-header-menu--layout-default ">
            <ul class="kt-menu__nav ">
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel {{ Request::is('gym/email') ? 'kt-menu__item--active' : null }}" >
                    <a href="{{url('gym/email')}}" class="kt-menu__link ">
                        <span class="kt-menu__link-text">Home</span>
                    </a>
                </li>
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel {{ Request::is('gym/email/employee/*') ? 'kt-menu__item--active' : null }}" >
                    <a href="{{url('gym/email/employee')}}" class="kt-menu__link">
                        <span class="kt-menu__link-text">Employee</span>
                    </a>
                </li>
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel {{ Request::is('gym/email/member/*') ? 'kt-menu__item--active' : null }}">
                    <a href="{{url('gym/email/member')}}" class="kt-menu__link">
                        <span class="kt-menu__link-text">Member</span>
                    </a>
                </li>
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel {{ Request::is('gym/email/lead/*') ? 'kt-menu__item--active' : null }}" >
                    <a href="{{url('gym/email/lead')}}" class="kt-menu__link">
                        <span class="kt-menu__link-text">Lead</span>
                    </a>
                </li>
                <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel {{ Request::is('gym/email/trainer/*') ? 'kt-menu__item--active' : Request::is('gym/member/create') ? 'kt-menu__item--active' : null }}">
                    <a href="{{url('gym/email/trainer')}}" class="kt-menu__link">
                        <span class="kt-menu__link-text">Trainer</span>
                    </a>
                </li>
            </ul>
        </div>
